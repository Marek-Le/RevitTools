...
using CefSharp;
using TeslaRevitTools.Gigabase;
using MS.WindowsAPICodePack.Internal;

namespace NavisworksGigabaseTsla
{
    public class GigabaseViewModel : INotifyPropertyChanged
    {
        public Thread WindowThread { get; set; }
        public GigabaseAction GigabaseAction { get; set; }
        ...
        public GigabaseWindow GigabaseWindow { get; set; }
        public bool IsBusy { get; set; } = false;
        public ManualResetEvent SignalEvent = new ManualResetEvent(false);

        public GigabaseViewModel()
        {
        ...
        {           
            ...
            //SignalEvent.WaitOne();
            //SignalEvent.Reset();
            //GigabaseWindow.SubscribeEvents();
            //List<string> notFound = searchMarks.Where(e => !tagsFound.Contains(e)).ToList();
            //GigabaseWindow.Browser.ExecuteScriptAsync($"console.log('var found = {JsonConvert.SerializeObject(tagsFound)}; var not_found = {JsonConvert.SerializeObject(notFound)};');");
        }
        ...
        public void DisplayWindow()
        {
            ...
            {
                GigabaseWindow = new GigabaseWindow(this);
                GigabaseWindow.Show();
                Dispatcher.Run();
            });
