...
{
    public static class CustomPrintForm
    {
      ...
      string pDrive,
        ...
        public static void DeleteCustomForm(string printerName, string paperName, bool overrideAccess)
        {
        ...
        public static void AddCustomPaperSizeToDefaultPrinter(string paperName, float widthMm, float heightMm)
        {
            ...
            AddCustomPaperSize(sPrinterName, paperName, widthMm, heightMm, true);
        }
        ...
        public static void AddCustomPaperSize(string printerName, string paperName, float
          widthMm, float heightMm, bool overrideAccess)
        {
