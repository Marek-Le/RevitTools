...
namespace TeslaRevitTools.ConvoidOpenings
{
    public class ConvoidViewModel : INotifyPropertyChanged
    {
        ...
        private static string appDataPath = Path.Combine(Environment.GetFolderPath(Environment.SpecialFolder.ApplicationData), "TslaOpeningUpdater");
        ...
        public async void DownloadAndExtractData()
        {
            try
            {
                ...
                string downloadPath = "http://ber02p1egeap001.teslamotors.com/convoid/opening_updater.zip";
        ...
        private void ViewModelInitialize()
        {
            ...
            HostReferenceLookups = new List<HostReferenceLookup>
            {
                ...
                new HostReferenceLookup()
                {
                    HostLookup = "TSLA - Building Element Id",
                    ReferenceLookup = "TSLA - MEP Element Id"
                }
            };
        }
        ...
        public void AddExportedOpeningData()
        {
            ...
            foreach (var item in SelectedOpeningElements)
            {
                ...
                string gridInfo = GetParameterValue("71e80743-7892-44e3-9b9f-3b0867ff9e23", "TSLA - Nearest Grid Intersection", item);
                string discipline = GetParameterValue("fc977b48-f0b7-47c3-8cb0-11747978d80f", "TSLA - MEP Discipline", item);
                string coords = GetParameterValue("301cbf36-67d2-4017-b572-653622865592", "DEV_BL_TopCoordinates", item);

                if (oType == "Round")
                {
                    string size = new string(GetParameterValue("6943c8a0-7c60-4716-ba22-ee426e3a9b90", "TSLA - Opening Size", item).ToArray());
                ...
                {
                    string size = GetParameterValue("6943c8a0-7c60-4716-ba22-ee426e3a9b90", "TSLA - Opening Size", item);
        ...
        public List<Definition> GetSharedParameters(Application app)
        {
            ...
            string tslaParameters = "TslaOpenings";
            string shPath = Path.Combine(appDataPath, sharedParameterFileName);
            app.SharedParametersFilename = shPath;
            DefinitionFile definitionFile = app.OpenSharedParameterFile();

            List<DefinitionGroup> defGroups = definitionFile.Groups.Where(e => e.Name == sharedParameterGroupName || e.Name == tslaParameters).ToList();
        ...
        public void ExportOpenings(List<FamilyInstance> familyInstances)
        {
            ...
            exportParameters.Add("TSLA - Tag Ref", new Guid("ddea1a78-1945-4111-9b1e-30663895d189")); //TSLA - Tag Ref / ddea1a78-1945-4111-9b1e-30663895d189
            exportParameters.Add("TSLA - Opening Unique Identifier", new Guid("f0261f82-a41f-4571-ac69-73660a6ede5f"));//TSLA - Opening Unique Identifier / f0261f82-a41f-4571-ac69-73660a6ede5f
            exportParameters.Add("TSLA - Opening Size", new Guid("6943c8a0-7c60-4716-ba22-ee426e3a9b90"));
            exportParameters.Add("TSLA - MEP System Abbreviation", new Guid("9cac14a4-de0a-48e8-ac01-2d408234b5b0"));
            exportParameters.Add("TSLA - MEP System", new Guid("5a28e083-f6a2-4620-9f20-67b7fe2bb976"));
            exportParameters.Add("TSLA - MEP Type", new Guid("51b64c76-a4d6-457c-9780-6db53e6ff794"));
            exportParameters.Add("TSLA - Grid Ref - Horizontal", new Guid("5cb42d75-99fd-4d98-9c06-79a23ac81646"));
            exportParameters.Add("TSLA - Grid Ref - Vertical", new Guid("379b6e83-48a3-4678-81ac-6b35176ca510"));
            exportParameters.Add("TSLA - Grid Ref - Position EW", new Guid("ba63fd02-087d-4972-9f79-db867613b214"));
            exportParameters.Add("TSLA - Grid Ref - Position NS", new Guid("ea1f66c3-0b7a-41f5-8db8-56f1f45b88db"));
            exportParameters.Add("TSLA - Relevant Level", new Guid("c6597d59-0383-41d9-a50c-8299f94ff7c7"));
            exportParameters.Add("TSLA - Nearest Level Below", new Guid("65d3b25a-8ce6-40a4-ac3f-3ef743f659d2"));
            exportParameters.Add("TSLA - Elevation from Nearest Level Below", new Guid("c36f602e-7220-4c63-ae05-933cb59334f7"));
            exportParameters.Add("TSLA - Intersection Location", new Guid("7c5efcb5-44f3-4cb7-8da0-8e79769d828b"));
            exportParameters.Add("TSLA - Intersection Orientation", new Guid("7ea3a9c8-442e-43ff-8811-634cd93a73a2"));
            exportParameters.Add("TSLA - Building Element Category", new Guid("e20e771b-da9a-4070-945a-f581b337775c"));
            exportParameters.Add("TSLA - Building Element Id", new Guid("483ee3f4-1fba-46f3-8c9f-07c406e22e0d"));
            exportParameters.Add("TSLA - Building Element Type", new Guid("94d26f96-0ddc-465c-b0f2-8d1aa3c61151"));
            exportParameters.Add("TSLA - Building Element Source File", new Guid("a88619d6-7faa-4fa0-9b7e-5c64d26945b5"));
            exportParameters.Add("TSLA - MEP Element Category", new Guid("6aefa1d1-642a-4c5e-9b4a-bf0a44187f79"));
            exportParameters.Add("TSLA - MEP Element Id", new Guid("01c9b9c1-019d-4052-a54a-1a3be6058521"));
            exportParameters.Add("TSLA - MEP Element Source File", new Guid("2848d97e-99fe-47da-98b0-ee041eb33a21"));
            exportParameters.Add("TSLA - MEP Element Workset", new Guid("87e942d2-3c95-435a-8a87-9f6864f86f73"));
            exportParameters.Add("TSLA - MEP Discipline", new Guid("fc977b48-f0b7-47c3-8cb0-11747978d80f"));
            try
            {
