...
#if DEBUG2020 || RELEASE2020
            string newTypeName = "TSLA_XX_" + minPrintHeight.ToString("F0") + "x" + UnitUtils.ConvertFromInternalUnits(totalWidth, DisplayUnitType.DUT_MILLIMETERS).ToString("F0");
#elif DEBUG2023 || RELEASE2023
            string newTypeName = "TSLA_XX_" + minPrintHeight.ToString("F0") + "x" + UnitUtils.ConvertFromInternalUnits(totalWidth, UnitTypeId.Millimeters).ToString("F0");
#endif
