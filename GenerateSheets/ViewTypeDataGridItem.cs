        ...
        private void FindPreselectedTemplateIndex()
        {
            ...
            switch (ViewType)
            {
                case ViewType.FloorPlan:
                     index = ViewTemplates.FindIndex(e => e.Name == "TSLA_LPH5_A_FP");
                    if(index > 0)
                    {
                ...
                case ViewType.CeilingPlan:
                    index = ViewTemplates.FindIndex(e => e.Name == "TSLA_LPH5_A_RCP");
                    if (index > 0)
                    {
                        PreSelectedTemplateIndex = index;
                    }
                ...
                case ViewType.Elevation:
                    index = ViewTemplates.FindIndex(e => e.Name == "TSLA_LPH5_A_EL");
                    if (index > 0)
                    {
                        PreSelectedTemplateIndex = index;
                    }
                ...
                case ViewType.ThreeD:
                    index = ViewTemplates.FindIndex(e => e.Name == "TSLA_LPH5_A_3D");
                    if (index > 0)
                    {
                        PreSelectedTemplateIndex = index;
                    }
