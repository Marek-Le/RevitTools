...
namespace TeslaRevitTools.ExStorageSchema
{
    public class TeslaSchema
    {
        ...
        public static TeslaSchema Initialize()
        {
            TeslaSchema result = new TeslaSchema();
            result.GetSchema();
            return result;
        }
        ...
        private Schema CreateSchema()
        {
            ...
            schemaBuilder.SetVendorId("TSLA");
            schemaBuilder.SetSchemaName("TSLA_Optimiser");
